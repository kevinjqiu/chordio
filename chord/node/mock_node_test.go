...
func (_m *MockNode) ClosestPrecedingFinger(ctx context.Context, id chord.ID) (chord.Node, error) {
...
func (_m *MockNode) FindPredecessor(ctx context.Context, id chord.ID) (chord.Node, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockNode) FindSuccessor(ctx context.Context, id chord.ID) (chord.Node, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockNode) GetPredNode() chord.NodeRef {
	ret := _m.Called()
...
func (_m *MockNode) GetSuccNode() chord.NodeRef {
	ret := _m.Called()
...
func (_m *MockNode) SetPredNode(ctx context.Context, n chord.NodeRef) {
	_m.Called(ctx, n)
}

// SetSuccNode provides a mock function with given fields: ctx, n
func (_m *MockNode) SetSuccNode(ctx context.Context, n chord.NodeRef) {
	_m.Called(ctx, n)
}
...
func (_m *MockNode) UpdateFingerTableEntry(ctx context.Context, s chord.Node, i int) error {
...
func (_m *MockNode) setNodeFactory(f factory) {
	_m.Called(f)
}

...
func (_m *MockNode) ClosestPrecedingFinger(ctx context.Context, id chord.ID) (Node, error) {
...
func (_m *MockNode) FindPredecessor(ctx context.Context, id chord.ID) (Node, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockNode) FindSuccessor(ctx context.Context, id chord.ID) (Node, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockNode) SetPredNode(ctx context.Context, n NodeRef) {
	_m.Called(ctx, n)
}

// SetSuccNode provides a mock function with given fields: ctx, n
func (_m *MockNode) SetSuccNode(ctx context.Context, n NodeRef) {
	_m.Called(ctx, n)
}

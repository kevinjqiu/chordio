...
func (_m *MockLocalNode) ClosestPrecedingFinger(_a0 context.Context, _a1 chord.ID) (Node, error) {
...
func (_m *MockLocalNode) FindPredecessor(_a0 context.Context, _a1 chord.ID) (Node, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockLocalNode) FindSuccessor(_a0 context.Context, _a1 chord.ID) (Node, error) {
	ret := _m.Called(_a0, _a1)
...
func (_m *MockLocalNode) setLocalNodeConstructor(_a0 localNodeConstructor) {
	_m.Called(_a0)
}

// setRemoteNodeConstructor provides a mock function with given fields: _a0
func (_m *MockLocalNode) setRemoteNodeConstructor(_a0 remoteNodeConstructor) {
	_m.Called(_a0)
}
